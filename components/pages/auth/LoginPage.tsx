...
function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6 lg:p-10">
      <div className="w-full max-w-5xl bg-background rounded-2xl shadow-lg border border-border dark:shadow-[0_10px_15px_-3px_rgb(255,255,255,0.05),0_4px_6px_-4px_rgb(255,255,255,0.05)] overflow-hidden flex flex-col lg:flex-row min-h-[500px] lg:min-h-[600px]">

        {/* Left Side - Image */}
        <div
          className={cn(
            "hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center",
